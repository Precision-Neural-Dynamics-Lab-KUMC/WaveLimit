...
% Set default sorting options for WaveLimit spike sorting
sorting_options.max_ISI = 1.5;  %Maximum Interspike Interval time to be considered a violation in ms
sorting_options.min_ISI = 0.675;  %Minimum time that can occur between spikes, hardware and spike thresholding dependent
